...
import { handleDebug, handleContinue, handleRun, handleStep } from "@/helpers/control";
...
export default function Toolbar() {
    ...
    return (
        <div id="toolbar" className="  text-gray-400 py-1 px-2">
            ...
            <span>Run: <i title="run" onClick={() => handleRun(source, ass_source)} className={activeBtn(toolbar_btn.state.run) + " hover:bg-gray-600 cursor-pointer p-1"}><Icon icon="codicon:run-all" /></i></span>
